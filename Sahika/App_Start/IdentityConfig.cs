...
namespace Sahika.App_Start
{
    public class IdentityConfig
    {
        ...
        public class ApplicationUserManager : UserManager<ApplicationUser, int>
        {
                ...
                IOwinContext context)
            {
                ...
                var manager = new ApplicationUserManager(
                    new ApplicationUserStore(context.Get<SahikaContext>()));
        ...
        public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
        {
                ...
                IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
            {
                return new ApplicationRoleManager(
                    new ApplicationRoleStore(context.Get<SahikaContext>()));
            }
        }
        ...
        public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<SahikaContext>
        {
            protected override void Seed(SahikaContext context)
            {
            ...
            public static void InitializeIdentityForEF(SahikaContext db)
            {
